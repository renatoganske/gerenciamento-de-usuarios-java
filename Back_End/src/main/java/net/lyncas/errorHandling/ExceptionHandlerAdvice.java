package net.lyncas.errorHandling;

import net.lyncas.errorHandling.dto.ApiErrorDto;
import net.lyncas.errorHandling.dto.ErrorDto;
import net.lyncas.errorHandling.exception.contract.MessageException;
